...
import com.example.lab10.api.SerieApiService
import retrofit2.Retrofit
import retrofit2.converter.gson.GsonConverterFactory

@Composable
fun SeriesApp() {
    val urlBase = "http://192.168.207.91:8000/" // o tu IP si usarás un dispositivo externo
...
@Composable
fun ScreenInicio() {
    // Box se utiliza para centrar el texto
    Box(
        modifier = Modifier.fillMaxSize(),
        contentAlignment = Alignment.Center
    ) {
        Text(text = "Hola", fontSize = 32.sp)
    }
}